/*
	...
	Description:
	Map représente la carte sur laquelle se déplacent les animaux,
	elle est composée de cases (tableau de Case à 2 dimensions)
	et elle contient tous les objets (animaux, nourriture...) présents sur la carte (ArrayList d'Objet).
*/
...
public class Map 
{
	...
	public Position getDirection(Animal animal, Position pObjectif)
	{
		...
		Hashtable<Position, Noeud> listeFermée = new Hashtable<Position, Noeud>();
		// TODO
		return p;
	}
	...
	private void etudierCasesAdjacentes(Position p)
	{
		Noeud temp = new Noeud();
		 ...
		 {
		        if ((i >= 0) || (i < nbColonnes))  // si la coordonnée appartient bien à la map
		        {
